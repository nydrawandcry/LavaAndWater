...
- проверка ситуации где несколько жетонов (корректно ли собираются) - проверка активации выхода с одним жетоном (проверяем выход (должен быть заблокирован), игрок берет жетон и проверяем выход снова (выход должен быть разблокирован))
